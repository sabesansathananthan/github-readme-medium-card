...
const blogCard = async (data, theme = 'dark') => {
  ...
  return `
    ...
    <path id="blogName" d="M0,20 H235 M0,35 H235 M0,50 H240 M0,65 H235">     </path>
      ...
      <linearGradient spreadMethod="pad" id="light" x1="0%" y1="0%" x2="0%" y2="100%">
   ...
   <text transform="translate(100,0)" fill="${theme == 'light' ? 'black' : 'white'}" font-size="13">
    <textPath xlink:href="#blogAuthor">${data.author}</textPath>
   </text>
   <text transform="translate(100,0)" fill="${theme == 'light' ? 'black' : 'white'}" font-size="12">
